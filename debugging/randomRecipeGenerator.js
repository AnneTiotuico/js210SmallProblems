...
as we might expect in JavaScript. The binary + operator is either an arithmetic
operator adding two numerical values, or a string operator concatenating two
strings. When we apply it to two arrays, JavaScript will convert the arrays
into strings, and then concatenate these strings. So dish and dishName are
strings. This is why invoking join on them raises an error: join is not a
method defined for strings.
