...
// But it throws a TypeError, saying: Cannot read property 'forEach' of undefined.
// Why is that?
...
string. Since the empty string does not contain such a property,
...
Semicolons should always terminate a statement. With no semicolon to separate
them, JavaScript sometimes sees the next statement as part of the former
statement, which leads to undesired behavior.

By the way: did you notice that we didn't use any other semicolons?
Only the one on line 1 causes a problem. Automatic semicolon insertion
works as intended on the remaining lines.
*/